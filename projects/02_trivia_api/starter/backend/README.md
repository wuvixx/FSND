...
### DELETE /questions/[id]
**General:**
* Deletes a question, returns a success value, and the id of the question deleted.
...
* Expects JSON data containing a `previous_questions` array for question ids that have already been answered, and a `quiz_category` > `id` category id.
**Sample:** `curl -X POST -H "Content-Type: application/json" \
